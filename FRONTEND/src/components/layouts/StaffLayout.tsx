...
const sidebarItems = [
    ...
    { path: '/staff/leaves', label: 'Leave Management', icon: FaClipboardList },
                    ...
                    >
                        ...
                        <div className="p-6 border-b border-gray-100">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="font-bold text-gray-800 text-lg">Staff Portal</h1>
                        ...
                        <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-1 custom-scrollbar">
                            {sidebarItems.map((item) => {
                                ...
                                return (
                                    ...
                                    >
                                        <item.icon className={`text-lg ${isActive ? 'text-emerald-600' : 'text-gray-400'
                                            }`} />
