...
const sidebarItems = [
    ...
    { path: '/student/media', label: 'Media Center', icon: FaImage },
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex overflow-hidden">
            ...
            <AnimatePresence mode="wait">
                {isSidebarOpen && (
                    <motion.aside
                        ...
                        className="w-[280px] bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-800 z-20 hidden md:flex flex-col h-screen fixed left-0 top-0 print:hidden"
                    >
                        {/* Header */}
                        <div className="p-6 border-b border-gray-100 dark:border-slate-800">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="font-bold text-gray-800 dark:text-gray-100 text-lg">Student Portal</h1>
            ...
            <div className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ${isSidebarOpen ? 'md:ml-[280px]' : ''}`}>
                {/* Topbar */}
                <header className="print:hidden sticky top-0 z-10 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-gray-200 dark:border-slate-800 h-16 px-6 flex items-center justify-between">
